...
public class GetAllEmployees extends HttpServlet {
	private static final long serialVersionUID = 1L;
  	...
  	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  		...
  		out.println("<table border='1px'><tr><th>ID</th><th>NAME</th><th>SALARY</th><th>DEPT</th></tr>");
  		for (Employee employee : allEmployees) {
  			out.println("<tr>");
			out.println("<td>" + employee.getId() + "</td>");
			out.println("<td>" + employee.getName() + "</td>");//we are writing html code in our java code
			out.println("<td>" + employee.getSalary() + "</td>");//is difficult
